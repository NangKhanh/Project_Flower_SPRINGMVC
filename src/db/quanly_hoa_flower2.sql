...
DROP TABLE IF EXISTS `flower2`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `flower2` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `flower_code` varchar(255) DEFAULT NULL,
...
LOCK TABLES `flower2` WRITE;
/*!40000 ALTER TABLE `flower2` DISABLE KEYS */;
/*!40000 ALTER TABLE `flower2` ENABLE KEYS */;
UNLOCK TABLES;
