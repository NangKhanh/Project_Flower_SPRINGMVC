...
<div class="main-content">
    <form action="<c:url value='/hoa-don/danh-sach'/>" id="formSubmit" method="get">
                            ...
                            <div class="table-btn-controls">
                                <div class="pull-right tableTools-container">
                                    <div class="dt-buttons btn-overlap btn-group">
                                        <c:url var="createInvoiceURL" value="/hoa-don/chinh-sua">
                                            <c:param name="partnerId" value="${model.partnerId}"/>
                                        </c:url>
                                        <a flag="info"
                                           class="dt-button buttons-colvis btn btn-white btn-primary btn-bold" data-toggle="tooltip"
                                           title='Thêm hoá đơn' href='${createInvoiceURL}'>
															<span>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="table-responsive">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <c:url var="updateInvoiceURL" value="/hoa-don/chinh-sua">
                                                        ...
                                                        <c:param name="partnerId" value="${item.partnerId}"/>
                                                    </c:url>
                                                    <a class="btn btn-sm btn-primary btn-edit" data-toggle="tooltip"
                                                       title="Cập nhật hoá đơn" href='${updateInvoiceURL}'><i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                                    </a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    ...
                                    <input type="hidden" value="" id="partnerId" name="partnerId"/>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    function deleteNew(data) {
        $.ajax({
            ...
            success: function (result) {
                window.location.href = "${invoiceURL}?page=1&limit=5&message=delete_success&partnerId=" +partnerId;
            },
